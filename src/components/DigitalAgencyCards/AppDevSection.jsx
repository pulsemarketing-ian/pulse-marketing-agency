...
const AppDevSection = () => {
  return (
    <main 
    className="relative  md:pb-[15vh] text-white overflow-hidden md:translate-y-0" 
    style={{
   ...
   <div className=" md:container md:mx-auto md:px-4 md:py-2 pt-8 md:pt-0">
   <div 
        className="rounded-xl p-3 md:p-8 flex flex-col lg:flex-row gap-8 items-center justify-between transform transition-transform duration-700 ease-in-out hover:scale-105 md:translate-y-22  md:mt-0"
        style={{
