        ...
        <main 
         style={{
            ...
            <div className='h-[80vh] md:h-[100vh]  flex justify-between items-center flex-row relative w-[1200px] mx-auto'>
                {/* hero heading  */}
                <div className=" w-full px-6 md:px-0 md:w-[45%] flex-col translate-y-[-30%] md:translate-y-0">
                    ...
                    {/* heading main  */}
                    <Reveal>
                        <h2 className="text-2xl md:text-5xl font-medium leading-tight text-left">
