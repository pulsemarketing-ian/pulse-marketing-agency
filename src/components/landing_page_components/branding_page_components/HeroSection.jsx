        ...
        <main 
         style={{
            ...
            <div className='h-[100vh]  flex justify-between items-center flex-row relative w-[1200px] mx-auto'>
                {/* hero heading  */}
                <div className="w-[45%] flex-col px-8 md:px-0">
                    ...
                    {/* hero form  */}
                    <div className="w-[40%] bg-white bg-opacity-10 backdrop-blur-md rounded-3xl py-5 px-10 max-w-md translate-y-8 shadow-lg text-white">
