    ...
    <section className="text-white md:py-16 md:pt-[-20px] pb-16 md:pb-0 md:w-[1200px] md:mx-auto px-6 md:px-0">
      <div className="md:container mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <motion.div
          ...
          className="md:w-1/2 space-y-4 hidden md:block"
        >
          <Reveal>
          ...
          <Reveal>
            <p className="text-gray-300 text-[15px]">
              ...
              they are a strategic blend of creativity and psychology, carving unique identities
        ...
        <motion.div
          ...
          className="md:w-1/2 w-full flex justify-center hidden md:block"
          style={{
