...
const Strategies = () => {
  return (
    <main className="w-[1200px] mx-auto py-10 flex flex-nowrap justify-between "  >
        <div className="flex flex-col gap-4 w-[48%]">
            <h2 className="text-4xl font-bold tracking-wide">We implement the latest<br/> SEO strategies and <br/>marketing techniques</h2>
        ...
        <div className="w-[48%] flex justify-items-end justify-end"  style={{
