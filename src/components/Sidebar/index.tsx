...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Header", route: "/forms/header" },
          { label: "Hero Section", route: "/forms/hero-section" },
          { label: "Why Choose Us", route: "/forms/choose-us" },
          { label: "Portfolio Content", route: "/forms/portfolio-content" },
          { label: "Tabs Top Content", route: "/forms/tabs-top-content" },
          { label: "Cards Upper Content", route: "/forms/cards-upper-content" },
          { label: "Calendar Section", route: "/forms/calendar-content" },
        ],
      },
      {
        icon: (
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            {/* <Image
              ...
              priority
            /> */}
            <h2 className="text-cyan-300 text-2xl font-bold ">Pulse  Marketing</h2>
          </Link>
