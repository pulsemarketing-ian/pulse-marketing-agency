...
const Page = () => {
    ...
    const GettingHeaderData = async () => {
        try {
            const res = await FireApi('component/read/?section=digital-agency-content', "GET");
            if (res.status === true) {
        ...
        <DefaultLayout>
            <div className='w-full flex items-center justify-center'>
                <div className='bg-white lg:w-[60%] mx-auto rounded-md shadow-2 p-6'>
                    <h2 className='text-black text-lg font-bold mb-4'>Manage Your Cards <br/> Upper Content</h2>
